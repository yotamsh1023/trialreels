...
export default function Signup() {
  ...
  async function handleSignInWithGoogle() {
    ...
    try {
      ...
      if (err.message === 'Failed to fetch') {
        ...
        setError(err.message || 'אירעה שגיאה בהרשמה. נסו שוב.')
      }
      setLoading(false)
    }
  }
  ...
  if (user) {
    return (
      <div className="page">
        <div className="page-card">
          <h1 className="page-title">אתה כבר מחובר</h1>
          <p className="page-subtitle">
            המשך לחבר את חשבון האינסטגרם שלך כדי להתחיל.
          </p>
          <button
            type="button"
  ...
  return (
    <div className="page">
      <div className="page-card">
        <h1 className="page-title">הרשמה ל-Reels AutoPoster</h1>
        <p className="page-subtitle">
          הצטרפו למערכת שמעלה את הרילס שלכם באופן אוטומטי כל יום! התחברו עם חשבון Google.
        </p>

        {error && (
          <div id="signup-error" className="alert alert-error" role="alert" aria-live="assertive">
